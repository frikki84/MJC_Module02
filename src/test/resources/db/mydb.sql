...
CREATE TABLE gift_certificate_has_tag (
  ...
  KEY `gift_certicicate_id_gift_certicicate` (`gift_certicicate_id_gift_certicicate`),
  KEY `tag_id_tag` (`tag_id_tag`),
...
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (1, 1);
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (1, 2);
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (2, 3);
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (3, 4);
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (3, 5);
INSERT INTO gift_certificate_has_tag (`id`, `nameTag`) VALUES (4, 6);
